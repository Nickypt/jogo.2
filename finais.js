function verificarFimDeJogo() {
    ...
    function prepararTelaFinal(classeEstetica) {
        ...
        // GERAÇÃO DO PLACAR DE CONQUISTAS DO SISTEMA
        ...
        if (conquistas.investigadorQuantico >= 2) {
            htmlConquistas += `<p style="color:#ffcc00; margin:4px 0;">🔎 [MEDALHA: INVESTIGADOR QUÂNTICO] - Descriptografou e expôs a conspiração nos arquivos ocultos corporativos.</p>`;
        } else {
